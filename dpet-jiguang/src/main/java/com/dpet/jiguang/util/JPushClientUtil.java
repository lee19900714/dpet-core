...
public class JPushClientUtil {
    ...
    private static JPushClient jPushClient = JPushConfig.getJPushClient();
    ...
    public static void main(String[] args){
        if(JPushClientUtil.sendToAll("通知内容标题","消息内容标题","这是一条测试消息内容","{title:\"1111\",content:\"111\",model:\"009005\"}")==1){
