...
<head>
    ...
    <title>在线宠物教育后台管理系统</title>
    <meta name="keywords" content="在线宠物教育后台管理系统">
    <meta name="description" content="在线宠物教育后台管理系统">
    ...
    <link rel="stylesheet" href="../static/web/css/merchant.css">
...
<body>
    <a href="login.html"><img class="login-logo" src="../static/web/img/logo.png"></a>
   ...
   <div class="login-name">管理员登录</div>
    ...
    <div class="login-footer clearfix">Copyright © 2019 在线宠物教育 depet.com  All Rights Reserved.</div>
</body>
