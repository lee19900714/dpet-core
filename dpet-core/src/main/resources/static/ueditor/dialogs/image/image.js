    ...
    UploadImage.prototype = {
                ...
                try {
                    ...
                    if (json.success) {
                    	...
                    	for(var i = 0; i < data.length; i++){
                    		...
                    		image.url = data[i].file_url;
                    		image.title = data[i].file_real_name;
                    		image.original = data[i].file_name;
                    		images.push(image);                    		
                    	}
                    	_this.imageList.push(images);
        ...
        getInsertList: function () {
            ...
            for (i = 0; i < this.imageList.length; i++) {
                ...
                list.push({
                    src: prefix + data[0].url,
                    _src: prefix + data[0].url,
                    title: data[0].title,
                    alt: data[0].original,
                    floatStyle: align
                });
