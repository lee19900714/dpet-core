...
(function () {
    ...
    var URL = window.UMEDITOR_HOME_URL || (function(){
        ...
        function PathStack() {
            ...
            this.documentURL = location.origin+'/static/umeditor1.2.3-utf8-jsp/';
    ...
    window.UMEDITOR_CONFIG = {
        ...
        //图片上传配置区
       // ,imageUrl:root + '/admin/pub/attachment/singleUpload'            //图片上传提交地址
        ...
        ,toolbar:[
            ...
            'link unlink | emotion image video  | map  blockquote',
            '| horizontal print preview fullscreen', 'drafts', 'formula' ,' indent'
        ]
        ...
        ,initialFrameWidth:650 //初始化编辑器宽度,默认500
