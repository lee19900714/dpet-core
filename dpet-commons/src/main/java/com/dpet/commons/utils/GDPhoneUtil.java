...
public class GDPhoneUtil {
    public static String http(String url, Map<String, String> params, String method, boolean requestProperty, boolean printLn) throws IOException {
        URL u = null;
